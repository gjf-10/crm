...
<form class="layui-form" style="width:80%;">
        ...
        <div class="layui-input-block">
            <#if grade??>
                <select name="grade" >
                    ...
                    >⼀级菜单</option>
                    <option value="1" <#if grade==1>selected="selected"</#if>>
                        ⼆级菜单</option>
                    <option value="2" <#if grade==2>selected="selected"</#if>>
                        三级菜单</option>
                </select>
            </#if>
        </div>
    ...
    <#if grade==1>
        <div class="layui-form-item layui-row layui-col-xs12">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input userName"
                       lay-verify="required" name="url" id="url"
...
<script type="text/javascript" src="${ctx}/js/modules/add.js"></script>
</body>
</html>